...
export class migrateSignatureData1693837595304 implements MigrationInterface {
    name = 'migrateSignatureData1693837595304'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."wallets_type_enum" AS ENUM('cg_evm', 'evm', 'fuel')`);
        ...
        await queryRunner.query(`
            UPDATE wallets
            SET "signatureData" = jsonb_set("signatureData", '{type}', '"evm"')
            WHERE "signatureData" IS NOT NULL
        `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "wallets" DROP CONSTRAINT "UQ_7e6f9c225f82ece575c20b13223"`);
        await queryRunner.query(`CREATE TYPE "public"."wallets_type_enum_old" AS ENUM('cg_evm', 'evm')`);
        await queryRunner.query(`ALTER TABLE "wallets" ALTER COLUMN "type" DROP DEFAULT`);
