...
export class AddApprovalNotificationType1717010560545 implements MigrationInterface {
    name = 'AddApprovalNotificationType1717010560545'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."notifications_type_enum" RENAME TO "notifications_type_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."notifications_type_enum" AS ENUM('Follower', 'Mention', 'Reply', 'BanState', 'DM', 'Approval')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."notifications_type_enum_old" AS ENUM('Follower', 'Mention', 'Reply', 'BanState', 'DM')`);
